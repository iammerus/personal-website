  ...
  >
    ...
    <div class="container relative z-10 px-6 sm:px-8 lg:px-12">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <!-- Simplified name with better typography -->
        <div class="mb-8">
          <h1
            ref="nameRef"
            class="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-gray-900 dark:text-white mb-4 opacity-0 leading-tight"
          >
            <span class="inline-block">{{ displayName.split(' ')[0] }}</span>
            <br>
            <span class="inline-block bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">
              {{ displayName.split(' ').slice(1).join(' ') }}
            </span>
            <span
              ref="cursorRef"
              class="inline-block w-1 bg-blue-600 ml-2"
        ...
        >
          ...
          <div class="flex flex-wrap justify-center gap-4 max-w-2xl mx-auto">
            <div
              ...
              :key="highlight"
              class="inline-flex items-center gap-2 px-4 py-2 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-full text-sm font-medium text-gray-700 dark:text-gray-300"
            >
        ...
        >
          <a
            href="https://github.com/iammerus"
            aria-label="Visit GitHub profile"
            class="group flex items-center justify-center w-12 h-12 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-full text-gray-600 dark:text-gray-400 hover:text-white hover:bg-gray-900 hover:border-gray-900 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/melvin-mupondori-815318210/"
            aria-label="Visit LinkedIn profile"
            class="group flex items-center justify-center w-12 h-12 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-full text-gray-600 dark:text-gray-400 hover:text-white hover:bg-blue-600 hover:border-blue-600 transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            href="https://x.com/wezhirawevhu"
            aria-label="Visit Twitter profile"
            class="group flex items-center justify-center w-12 h-12 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 rounded-full text-gray-600 dark:text-gray-400 hover:text-white hover:bg-black hover:border-black transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
